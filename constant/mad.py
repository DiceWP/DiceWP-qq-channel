...
LI = [
    ...
    "2) 被窃（Robbed）：调查员在 %(last)s 小时后恢复清醒，发觉自己被盗，身体毫发无损。如果调查员携带着宝贵之物（见调查员背景），做幸运检定来决定其是否被盗。所有有价值的东西无需检定自动消失。",
    "3) 遍体鳞伤（Battered）：调查员在 %(last)s 小时后恢复清醒，发现自己身上满是拳痕和瘀伤。生命值减少到疯狂前的一半，但这不会造成重伤。调查员没有被窃。这种伤害如何持续到现在由守秘人决定。",
    ...
    "6) 重要之人（Significant People）：考虑调查员背景中的重要之人，及其重要的原因。在 %(last)s 小时或更久的时间中，调查员将不顾一切地接近那个人，并为他们之间的关系做出行动。",
    ...
    "9) 恐惧（Phobia）：调查员患上一个新的恐惧症。\n%(symptom)s\n调查员在 %(last)s 小时后回过神来，并开始为避开恐惧源而采取任何措施。",
    "10) 狂躁（Mania）：调查员患上一个新的狂躁症。\n%(symptom)s\n调查员会在 %(last)s 小时后恢复理智。在这次疯狂发作中，调查员将完全沉浸于其新的狂躁症状。这症状是否会表现给旁人则取决于守秘人和此调查员。"
]
